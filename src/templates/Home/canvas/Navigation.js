...
export default class Navigation {
  ...
  update() {
    ...
    // Apply limits
    this.view.position.value.x = Math.min(
      Math.max(this.view.position.value.x, this.view.position.limits.x.min),
      this.view.position.limits.x.max,
    );

    //Smoothing
    this.view.position.smoothed.x +=
      (this.view.position.value.x - this.view.position.smoothed.x) *
      this.view.position.smoothing;

    this.camera.modes.default.instance.position.copy(
      this.view.position.smoothed,
    );
